...
url = os.getenv("TILLACHI_ENDPOINT_URL", "").strip()
secret = os.getenv("TILLACHI_ENDPOINT_TOKEN", "").strip()
if not url or not secret:
    raise SystemExit("Fill TILLACHI_ENDPOINT_URL and TILLACHI_ENDPOINT_TOKEN in .env")

source_price_id = int(time.time())
main_rate = 890
price_ranges = calculate_prices(main_rate, "tillachi")
prices = {}
